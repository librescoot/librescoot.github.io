...
**Installer 1.3 is here!** The new stable release does the preparation up front:
...
The whole process is faster, more robust and easier to follow. Installer 1.3 is
available for Linux, macOS and Windows.

## Prepare first, then finish unattended

The old installer required the USB cable to be moved several times during an
installation. Installer 1.3 groups the work involving the laptop at the start.
...
Installer 1.3 can upgrade an existing Librescoot system. Settings, paired
